...
const STYLE_ID = "zommy-intro-css";
const INTRO_CSS = `
...
export default function ZommyIntro() {
  ...
  return (
    <div aria-hidden="true" style={{ position: "fixed", inset: 0, zIndex: 2500, background: palette.milk, display: "grid", placeItems: "center", overflow: "hidden", pointerEvents: "none" }}>
      <div className="zommy-intro-shell" style={{ display: "grid", justifyItems: "center", gap: 18 }}>
        <div style={{ width: 168, height: 168, borderRadius: 48, background: palette.surface, border: "none", boxShadow: palette.sideShadow, display: "grid", placeItems: "center", position: "relative", overflow: "hidden" }}>
          <div className="zommy-intro-pulse" style={{ position: "absolute", inset: 18, border: `1px solid ${palette.accentLine}`, borderRadius: 38 }} />
          <svg viewBox="0 0 120 120" width="104" height="104" fill="none">
            <path className="zommy-intro-line" d="M24 58L60 30L96 58" stroke={palette.stone} strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
            <path className="zommy-intro-line" d="M36 54V92H84V54" stroke={palette.stone} strokeWidth="10" strokeLinecap="round" strokeLinejoin="round" />
            <path className="zommy-intro-heart" d="M60 84C49 76 42 68 42 58C42 51 48 46 55 46C59 46 62 48 65 52C68 48 72 46 76 46C83 46 89 51 89 58C89 70 75 79 60 88" fill={palette.accent} />
          </svg>
        </div>
        <div className="zommy-intro-word" style={{ color: palette.stone, fontFamily: type.serif, fontSize: 33, fontWeight: type.weight.heading, letterSpacing: 0 }}>Zommy</div>
      </div>
    </div>
  );
}
